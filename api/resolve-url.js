...
export default async function handler(req, res) {
  try {
    ...
    return res.status(200).json({ ok: true, candidates: unique(candidates).slice(0, 40), finalUrl: url, usedBrowserFallback: /403|forbidden|Page HTTP 403/i.test(fetchError) });
  } catch (e) {
